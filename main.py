...
if __name__ == '__main__':
    ...
    reconstruction = ImageReconstruction(image, block_size, args.level, args.wavelet)
    ...
    transmission.plot_efficiency(args.result_dir)
    reconstruction.plot_loss(args.result_dir)
